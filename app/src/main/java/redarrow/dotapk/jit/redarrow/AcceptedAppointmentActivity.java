...
public class AcceptedAppointmentActivity extends AppCompatActivity {
    ...
    ListView acceptedAppointment;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_accepted_appointment);
        acceptedAppointment=(ListView)findViewById(R.id.lvAcceptedAppointment);
        ...
        String url = "https://red-arrow.herokuapp.com/api/appointment/accepted";
        StringRequest stringRequest=new StringRequest(Request.Method.GET,url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ListAdapter listAdapter = new AcceptedAppointmentAdapter(getApplicationContext(), notification);
                    acceptedAppointment.setAdapter(listAdapter);
                     progressDialog.dismiss();
                }
                catch(Exception e)
                {
